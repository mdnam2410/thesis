...
% Các chương nội dung
\include{1_introduction/_main}
\include{2_background/_main}
\include{3_related_works/_main}
\include{4_method/_main}
\include{5_results/_main}
\include{6_conclusion/_main}
